...
// required double longitude = 1;
inline bool GeoGrid_Location_Coordinate::has_longitude() const { return (_has_bits_[0] & 0x00000001u) != 0; }
...
// required double latitude = 2;
inline bool GeoGrid_Location_Coordinate::has_latitude() const { return (_has_bits_[0] & 0x00000002u) != 0; }
...
// required int64 id = 1;
inline bool GeoGrid_Location_ContactCenter::has_id() const { return (_has_bits_[0] & 0x00000001u) != 0; }
...
// required .proto.GeoGrid.Location.ContactCenter.Type type = 2;
inline bool GeoGrid_Location_ContactCenter::has_type() const { return (_has_bits_[0] & 0x00000002u) != 0; }
