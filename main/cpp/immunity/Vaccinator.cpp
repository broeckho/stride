...
//Vaccinator::Vaccinator(std::shared_ptr<Simulator> sim,
//                       const boost::property_tree::ptree& pt_disease)
//    : m_disease(pt_disease), m_sim(sim) {}
//
...
/// Create new immunization / vaccination profiles here

Vaccinator::Vaccinator(const boost::property_tree::ptree& pt_config, util::Random& rng)
	: m_pt_config(pt_config), m_rng(rng)
{}
