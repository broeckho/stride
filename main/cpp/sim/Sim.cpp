...
Sim::Sim()
    : m_config_pt(), m_contact_log_mode(Id::None), m_num_threads(1U), m_track_index_case(false),
	  m_adaptive_symptomatic_behavior(false), m_local_info_policy(), m_calendar(nullptr),
	  m_contact_profiles(), m_handlers(), m_infector(), m_population(nullptr), m_rn_manager(),
