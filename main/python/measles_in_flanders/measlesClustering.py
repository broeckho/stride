...
def postprocessing(transmissionProbabilities0to1, transmissionProbabilitiesRestricted, clusteringLevels, poolSize):
    outputDir = "."
...
def main(numRunsR0, numRunsER, numRunsFull, poolSize):
    ...
    runSimulations(numRunsR0, numRunsER, numRunsFull,
                    ...
                    clusteringLevels, poolSize)
    postprocessing(transmissionProbabilities0to1, transmissionProbabilitiesRestricted,
                    clusteringLevels, poolSize)

if __name__=="__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--numRunsR0", type=int, default=2000)
    parser.add_argument("--numRunsER", type=int, default=2000)
    parser.add_argument("--numRunsFull", type=int, default=200)
