...
def main(numRuns, transmissionProbabilities, clusteringLevels, numDays, poolSize):
    ...
    for scenario in scenarioNames:
        for level in clusteringLevels:
            EffectiveR.createEffectiveRScatterPlot(".", scenario, transmissionProbabilities, level, poolSize)
...
if __name__=="__main__":
    ...
    parser.add_argument("--transmissionProbs", type=float, nargs="+", default=numpy.arange(0.0, 1.05, 0.05), help="Transmission probabilities to test")
