...
TEST_F(DaycareGeneratorTest, OneLocationTest)
{
        ...
        m_geogrid_config.popInfo.popcount_daycare = 9000;
        ...
        EXPECT_EQ(poolsOfLoc1.size(), 3 * m_geogrid_config.pools.pools_per_daycare);
}
...
TEST_F(DaycareGeneratorTest, MultipleLocationsTest)
{
        ...
        m_geogrid_config.popInfo.popcount_daycare = 79998;
        ...
        for (size_t i = 0; i < sizes.size(); i++) {
                EXPECT_EQ(expected[i] * m_geogrid_config.pools.pools_per_daycare,
