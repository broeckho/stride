...
TEST_F(PreSchoolGeneratorTest, OneLocationTest)
{
        ...
        m_geogrid_config.popInfo.popcount_preschool = 9000;
...
TEST_F(PreSchoolGeneratorTest, MultipleLocationsTest)
{
        ...
        m_geogrid_config.popInfo.popcount_preschool = 79998;
        ...
        for (size_t i = 0; i < sizes.size(); i++) {
                EXPECT_EQ(expected[i] * m_geogrid_config.pools.pools_per_preschool,
