...
shared_ptr<GeoGrid> GetPopulatedGeoGrid(Population* pop)
{
        ...
        const auto school = make_shared<K12SchoolCenter>(0, Id::K12School);
        location->AddCenter(school);
        const auto schoolPool = new ContactPool(2, Id::K12School);
        school->RegisterPool(schoolPool);

        const auto community = make_shared<PrimaryCommunityCenter>(1, Id::PrimaryCommunity);
        ...
        const auto secondaryCommunity = make_shared<SecondaryCommunityCenter>(2, Id::SecondaryCommunity);
