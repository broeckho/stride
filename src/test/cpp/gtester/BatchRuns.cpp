...
const string BatchDemos::g_age_contact_matrix_file =
...
const map<string, unsigned int> BatchDemos::g_results { make_pair("default",
		829), make_pair("seeding_rate", 0), make_pair("immunity_rate", 5),
		make_pair("measles", 346093), make_pair("maximum", 600000) };
...
namespace {
string scenarios[] { "default", "seeding_rate", "immunity_rate", "measles",
		"maximum" };
...
INSTANTIATE_TEST_CASE_P(Run_default, BatchDemos,
		::testing::Combine(::testing::Values(string("default")),
				::testing::ValuesIn(threads)));

INSTANTIATE_TEST_CASE_P(Run_seeding_rate, BatchDemos,
		::testing::Combine(::testing::Values(string("seeding_rate")),
				::testing::ValuesIn(threads)));

INSTANTIATE_TEST_CASE_P(Run_immunity_rate, BatchDemos,
		::testing::Combine(::testing::Values(string("immunity_rate")),
				::testing::ValuesIn(threads)));

INSTANTIATE_TEST_CASE_P(Run_measles, BatchDemos,
		::testing::Combine(::testing::Values(string("measles")),
				::testing::ValuesIn(threads)));

INSTANTIATE_TEST_CASE_P(Run_maximum, BatchDemos,
		::testing::Combine(::testing::Values(string("maximum")),
				::testing::ValuesIn(threads)));
