...
public:
	HBM(const boost::property_tree::ptree& pt) :
			Belief(pt), m_num_contacts(0), m_num_contacts_infected(0), m_num_contacts_adopted(
					0), m_perceived_severity(0), m_perceived_susceptibility(0), m_perceived_benefit(
					1), m_perceived_barriers(1) {
	}
