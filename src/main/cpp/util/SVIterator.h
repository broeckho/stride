...
template <
	...
	>
class SVIterator : public std::iterator<
			std::random_access_iterator_tag, T, std::ptrdiff_t, P, R>
{
public:
	// ==================================================================
	...
	{
		return (m_p == other.m_p) && (m_c == other.m_c);
	}
...
private:
	...
	using container_pointer_type = typename std::conditional<
		is_const_iterator, const SegmentedVector<T, N>*, SegmentedVector<T, N>*>::type;
...
private:
	...
	{
		return m_c != nullptr && m_p < m_c->size();
	}
};
