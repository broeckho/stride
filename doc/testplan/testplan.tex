...
\newline
\textbf{How will we achieve this?}
We can easily check this by passing a geogrid to the populator who has a population size of 0. If there are no exception thrown we now that the function did finish correctly.
...
\newline
\textbf{How will we achieve this?}
We will achieve this by altering the configuration of the workplace sizes so that there are multiple. We can check if this was successful by analyzing the new populations' data.
